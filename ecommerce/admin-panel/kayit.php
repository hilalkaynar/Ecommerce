    ...
    <div class="login">
        ...
        <form action="islem.php" method="post">
            <div class="login-form">
                ...
                <button type="submit" href="kayit.php" name="kayit" class="btn btn-primary btn-large btn-block">Kayıt Ol</button>
            </div>
        </form>
        <a href="login.php"><button href="login.php" class="btn btn-primary btn-large btn-block">Giriş Yap</button></a>
        </div>
    </div>
</body>
</html>